    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "Creative Talks", url: "https://copernicus.com/insights" },
        ]}
      />
      <Header />
      <main className="min-h-screen">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[var(--copernicus-section-bg)]">
          <div className="mx-auto max-w-7xl">
            <div className="overflow-hidden rounded-2xl border border-[var(--copernicus-border)]">
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredPosts.slice(1).map((post) => (
                <div
                  key={post.id}
                  className="overflow-hidden rounded-xl border border-[var(--copernicus-border)] transition-all duration-300 flex flex-col h-full"
                >
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: "var(--copernicus-orange)" }}>
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6 text-white">Let's Connect Us</h2>
