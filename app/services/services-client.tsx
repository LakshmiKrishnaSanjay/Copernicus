        ...
        <section className="pt-24 pb-0 overflow-hidden">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-0">
            ...
            <div className="aspect-square relative overflow-hidden">
              <Image
                src="/work/grand-morin-branding.jpg"
                alt="Grand Morin Branding"
                fill
            ...
            <div className="aspect-square relative overflow-hidden">
              <Image
                src="/work/vivo-booth.jpg"
                alt="Vivo Exhibition Booth"
                fill
                className="object-cover hover:scale-105 transition-transform duration-500"
              />
            </div>
            <div className="aspect-square relative overflow-hidden">
              <Image
                src="/work/tote-bag.jpg"
                alt="Digital Branding Tote Bag"
                fill
                className="object-cover hover:scale-105 transition-transform duration-500"
              />
            </div>
            <div className="aspect-square relative overflow-hidden">
              <Image
                src="/work/vivo-social.jpg"
                alt="Vivo Social Media"
                fill
                className="object-cover hover:scale-105 transition-transform duration-500"
              />
            </div>
            ...
            <div className="aspect-square relative overflow-hidden">
              <Image
                src="/work/fastrack-booth.jpg"
                alt="Fastrack Exhibition Stand"
                fill
                className="object-cover hover:scale-105 transition-transform duration-500"
              />
            </div>
            <div className="aspect-square relative overflow-hidden">
              <Image
                src="/work/coca-cola.jpg"
                alt="Coca-Cola Campaign"
                fill
                className="object-cover hover:scale-105 transition-transform duration-500"
              />
            </div>
            ...
            <div className="aspect-square relative overflow-hidden">
              <Image
                src="/work/grocery-packaging.jpg"
                alt="Grocery Packaging Design"
                fill
                className="object-cover hover:scale-105 transition-transform duration-500"
              />
            </div>
            <div className="aspect-square relative overflow-hidden">
              <Image
                src="/work/panda-tubes.jpg"
                alt="Panda Product Tubes"
                fill
                className="object-cover hover:scale-105 transition-transform duration-500"
              />
            </div>
            <div className="aspect-square relative overflow-hidden">
              <Image
                src="/work/goodness-grocery.jpg"
                alt="Goodness Grocery Packaging"
                fill
                className="object-cover hover:scale-105 transition-transform duration-500"
              />
            </div>
            <div className="aspect-square relative overflow-hidden">
              <Image
                src="/work/social-media-mockup.jpg"
            ...
            <div className="aspect-square relative overflow-hidden">
              <Image
                src="/work/panda-ice-cream.jpg"
                alt="Panda Ice Cream Packaging"
                fill
                className="object-cover hover:scale-105 transition-transform duration-500"
              />
            </div>
            <div className="aspect-square relative overflow-hidden">
              <Image
                src="/work/vivo-flags.jpg"
                alt="Vivo Brand Flags"
                fill
                className="object-cover hover:scale-105 transition-transform duration-500"
              />
            </div>
            <div className="aspect-square relative overflow-hidden">
              <Image
                src="/work/vivo-billboard.jpg"
                alt="Vivo Billboard Campaign"
                fill
                className="object-cover hover:scale-105 transition-transform duration-500"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {services.map((service, index) => (
                <div
                  key={service.id}
                  id={service.id}
                  className="scroll-mt-24 bg-[var(--copernicus-section-bg)] rounded-2xl p-8 lg:p-10 border-2 border-transparent hover:border-[var(--copernicus-orange)] transition-all duration-300 group"
                >
                  <div className="space-y-6">
                    <div>
                      <h2
                        className="text-3xl sm:text-4xl font-semibold mb-4 leading-tight group-hover:text-[var(--copernicus-orange)] transition-colors duration-300"
                        style={{ color: "var(--copernicus-text-primary)" }}
                      >
                        {service.title}
                      </h2>
                    ...
                    <div className="pt-4 border-t border-[var(--copernicus-border)]">
                      <h3 className="text-sm font-semibold uppercase tracking-wider mb-4" style={{ color: "var(--copernicus-orange)" }}>
                        Key Capabilities
                      </h3>
                      <ul className="grid grid-cols-1 gap-3" style={{ color: "var(--copernicus-text-secondary)" }}>
                        {service.capabilities.slice(0, 5).map((capability) => (
                          <li key={capability} className="flex items-start text-sm">
                            <span className="mr-3 mt-1.5 w-1.5 h-1.5 rounded-full bg-[var(--copernicus-orange)] flex-shrink-0" />
